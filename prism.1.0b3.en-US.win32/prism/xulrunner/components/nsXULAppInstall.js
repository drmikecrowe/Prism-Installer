...
//@line 41 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 235 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 265 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
      aLeafName = appName;
//@line 270 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
    }
...
//@line 341 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
...
//@line 348 "z:\Development\moz1.9.2\src\xulrunner\setup\nsXULAppInstall.js"
  }
};
